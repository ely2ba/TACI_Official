...
class TACIAnalyzer:
    def __init__(self, base_path="/Users/elyb/Desktop/Projects/fresh_TACI"):
    ...
    def load_data(self):
        ...
        try:
            ...
            master_file = self.base_path / "graders/phase_00_to_03_condenser/master_per_output_paralegal.csv"
            self.data['master'] = pd.read_csv(master_file)
            
            # Load model grader matrix
            matrix_file = self.base_path / "graders/phase_04_composite_paralegal/model_grader_matrix_paralegal.csv"
            self.data['matrix'] = pd.read_csv(matrix_file)
            
            # Load occupation summary
            summary_file = self.base_path / "graders/phase_04_composite_paralegal/occupation_summary_paralegal.csv"
