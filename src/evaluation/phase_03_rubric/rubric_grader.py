...
Inputs
------
outputs/results/evaluated/phase_03_candidates.csv

Outputs
-------
outputs/results/evaluated/phase_03_rubric_per_output.csv
outputs/results/evaluated/rubric_cache.json   (persistent cache)
