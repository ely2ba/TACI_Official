...
WRAP_CSV    = Path("outputs/results/evaluated/wrapper_per_output_paralegal.csv")
PHASE1_CSV  = Path("outputs/results/evaluated/"
                   "schema_text_gui_per_output_paralegal.csv")
PHASE2_CSV  = Path("outputs/results/evaluated/"
