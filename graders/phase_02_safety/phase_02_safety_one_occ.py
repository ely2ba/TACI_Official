#!/usr/bin/env python3
"""
phase_02_safety_one_occ.py   –   Paralegal slice

• Reads  : graders/phase_01_schema/schema_text_gui_per_output_paralegal.csv
...
def main():
    ...
    p.add_argument("--phase01-csv", type=Path,
        default="graders/phase_01_schema/schema_text_gui_per_output_paralegal.csv")
