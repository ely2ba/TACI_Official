...
MASTER_CSV    = ROOT / "graders/phase_00_to_03_condenser" / "master_per_output_paralegal.csv"
PRICE_CSV     = ROOT / "graders/phase_04_composite"       / "model_price_ctx.csv"
WEIGHT_JS     = ROOT / "graders/phase_04_composite"       / "weights.json"
MANIFEST_CSV  = ROOT / "data/manifests/paralegal_tasks.csv"

OUT_DIR       = ROOT / "graders/phase_04_composite_paralegal"
